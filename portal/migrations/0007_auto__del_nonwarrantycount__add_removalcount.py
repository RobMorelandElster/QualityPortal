...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'NonWarrantyCount'
        db.delete_table(u'portal_nonwarrantycount')

        # Adding model 'RemovalCount'
        db.create_table(u'portal_removalcount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('warranty_removal_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('non_warranty_removal_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('as_of_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today, unique=True)),
        ))
        db.send_create_signal(u'portal', ['RemovalCount'])


    def backwards(self, orm):
        # Adding model 'NonWarrantyCount'
        db.create_table(u'portal_nonwarrantycount', (
            ('count', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('as_of_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today, unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'portal', ['NonWarrantyCount'])

        # Deleting model 'RemovalCount'
        db.delete_table(u'portal_removalcount')
