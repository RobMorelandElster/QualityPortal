...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CustomerMeterTrack.rma_number'
        db.delete_column(u'portal_customermetertrack', 'rma_number')

        # Deleting field 'CustomerMeterTrack.shipment'
        db.delete_column(u'portal_customermetertrack', 'shipment_id')

        # Adding field 'CustomerMeterTrack.rma'
        db.add_column(u'portal_customermetertrack', 'rma',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['portal.ElsterRma']),
                      keep_default=False)

        # Adding field 'CustomerMeterTrack.pallet'
        db.add_column(u'portal_customermetertrack', 'pallet',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'CustomerMeterTrack', fields ['elster_meter_serial_number', 'meter_barcode', 'rma']
        db.create_unique(u'portal_customermetertrack', ['elster_meter_serial_number', 'meter_barcode', 'rma_id'])

        # Deleting field 'Shipment.pallet_number'
        db.delete_column(u'portal_shipment', 'pallet_number')

        # Deleting field 'Shipment.reference_id'
        db.delete_column(u'portal_shipment', 'reference_id')

        # Adding field 'Shipment.rma'
        db.add_column(u'portal_shipment', 'rma',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['portal.ElsterRma']),
                      keep_default=False)

        # Adding field 'Shipment.originator'
        db.add_column(u'portal_shipment', 'originator',
                      self.gf('django.db.models.fields.CharField')(default='CUSTOMER', max_length=10),
                      keep_default=False)

        # Adding field 'Shipment.carrier'
        db.add_column(u'portal_shipment', 'carrier',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Shipment.notes'
        db.add_column(u'portal_shipment', 'notes',
                      self.gf('django.db.models.fields.TextField')(max_length=2000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'CustomerMeterTrack', fields ['elster_meter_serial_number', 'meter_barcode', 'rma']
        db.delete_unique(u'portal_customermetertrack', ['elster_meter_serial_number', 'meter_barcode', 'rma_id'])

        # Adding field 'CustomerMeterTrack.rma_number'
        db.add_column(u'portal_customermetertrack', 'rma_number',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'CustomerMeterTrack.shipment'
        db.add_column(u'portal_customermetertrack', 'shipment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.Shipment'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CustomerMeterTrack.rma'
        db.delete_column(u'portal_customermetertrack', 'rma_id')

        # Deleting field 'CustomerMeterTrack.pallet'
        db.delete_column(u'portal_customermetertrack', 'pallet')
        ...
        # Adding field 'Shipment.pallet_number'
        db.add_column(u'portal_shipment', 'pallet_number',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Shipment.reference_id'
        raise RuntimeError("Cannot reverse this migration. 'Shipment.reference_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Shipment.reference_id'
        db.add_column(u'portal_shipment', 'reference_id',
                      self.gf('django.db.models.fields.CharField')(max_length=25, unique=True),
                      keep_default=False)

        # Deleting field 'Shipment.rma'
        db.delete_column(u'portal_shipment', 'rma_id')

        # Deleting field 'Shipment.originator'
        db.delete_column(u'portal_shipment', 'originator')

        # Deleting field 'Shipment.carrier'
        db.delete_column(u'portal_shipment', 'carrier')

        # Deleting field 'Shipment.notes'
        db.delete_column(u'portal_shipment', 'notes')
