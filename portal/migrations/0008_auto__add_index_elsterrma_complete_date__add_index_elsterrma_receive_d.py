...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ElsterRma', fields ['complete_date']
        db.create_index(u'portal_elsterrma', ['complete_date'])

        # Adding index on 'ElsterRma', fields ['receive_date']
        db.create_index(u'portal_elsterrma', ['receive_date'])

        # Adding index on 'ElsterRma', fields ['create_date']
        db.create_index(u'portal_elsterrma', ['create_date'])

        # Adding index on 'ElsterRma', fields ['number']
        db.create_index(u'portal_elsterrma', ['number'])


    def backwards(self, orm):
        # Removing index on 'ElsterRma', fields ['number']
        db.delete_index(u'portal_elsterrma', ['number'])

        # Removing index on 'ElsterRma', fields ['create_date']
        db.delete_index(u'portal_elsterrma', ['create_date'])

        # Removing index on 'ElsterRma', fields ['receive_date']
        db.delete_index(u'portal_elsterrma', ['receive_date'])

        # Removing index on 'ElsterRma', fields ['complete_date']
        db.delete_index(u'portal_elsterrma', ['complete_date'])
    ...
    models = {
        ...
        u'portal.datareport': {
            'Meta': {'ordering': "['-pk']", 'object_name': 'DataReport'},
        ...
        u'portal.elstermetercount': {
            'Meta': {'ordering': "['-as_of_date']", 'object_name': 'ElsterMeterCount'},
        ...
        u'portal.elsterrma': {
            ...
            'complete_date': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'create_date': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            'receive_date': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'portal.removalcount': {
            'Meta': {'ordering': "['-as_of_date']", 'object_name': 'RemovalCount'},
            'as_of_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today', 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'non_warranty_removal_count': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'warranty_removal_count': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'portal.shipment': {
