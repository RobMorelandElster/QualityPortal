...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerMeterTrack.comments'
        db.add_column(u'portal_customermetertrack', 'comments',
                      self.gf('django.db.models.fields.TextField')(max_length=2000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerMeterTrack.comments'
        db.delete_column(u'portal_customermetertrack', 'comments')
